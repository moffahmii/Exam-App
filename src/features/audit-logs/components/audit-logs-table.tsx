            ...
            <Table className="table-fixed w-full p-4">
                ...
                <TableHeader className="bg-blue-600 hover:none">
                    <TableRow className="">
                        ...
                        <TableHead className="w-62.5 text-white text-sm font-medium uppercase">
                            User
                        </TableHead>
                        <TableHead className="w-95 text-white text-sm font-medium uppercase">
                            Entity
                        </TableHead>
                        <TableHead className="w-50 text-white text-sm font-medium uppercase">
                            Time
                        </TableHead>
                        <TableHead className="w-20 text-white text-sm font-medium uppercase ">
                            Sort
                        </TableHead>
                    </TableRow>
                </TableHeader>
                                ...
                                <TableRow
                                    ...
                                    <TableCell className="w-30">
                                        <div
                                            ...
                                            style={{ color: getActionColorHex(log.action) }}
                                        >
                                            {log.action}
                                        </div>
                                    ...
                                    <TableCell className="w-62.5">
                                        ...
                                        <div
                                            ...
                                            style={{ color: getRoleColorHex(log.actorRole) }} >
                                            {log.actorRole}
                                        </div>
                                    </TableCell>
                                    {/* ENTITY */}
