...
export function ResultsSkeleton() {
    // مصفوفة وهمية لتكرار الأسئلة في قائمة المراجعة
        ...
        <div className="bg-white font-mono p-6 h-auto w-full">
            <div className="max-w-7xl mx-auto flex flex-col gap-6">
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                    {/* 1. هيكل الرسم البياني (العمود الأيسر) */}
                    <div className="w-full lg:w-1/3 bg-blue-50/50 border border-blue-100 p-8 flex flex-col items-center justify-center min-h-[400px]">
                        {/* الدائرة الوهمية (Donut) */}
                        <div className="w-48 h-48 rounded-full border-[30px] border-blue-100/50 animate-pulse" />

                        {/* مفتاح الرسم البياني الوهمي */}
                    ...
                    {/* 2. هيكل قائمة الأسئلة (العمود الأيمن) */}
