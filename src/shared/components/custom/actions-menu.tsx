...
export function GlobalActionsMenu({ viewHref, editHref, onDelete }: GlobalActionsMenuProps) {
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuTrigger
                className="flex h-8 w-8 items-center justify-center bg-gray-200 hover:bg-gray-300 transition-colors item-end cursor-pointer"
            >
            ...
            <DropdownMenuContent
                align="end"
                sideOffset={5}
                className="w-[160px] p-0 bg-white border border-gray-200 "
            >
